...
@click.option('--is-system/--no-is-system', default=False, help='Filter by IsSystem flag')
...
@click.pass_context
def cmd(ctx,is_system,is_builtin,is_editable,member_only,admin_only,as_json):
    """
